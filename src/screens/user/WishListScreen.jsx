...
const breadcrumbItems = [
  { label: "Shop", link: "/" },
  { label: "Sản phẩm yêu thích", link: "/wishlist" },
];
    ...
    <WishListScreenWrapper className="page-py-spacing">
      <Container>
        ...
        <UserDashboardWrapper>
          <UserMenu />
          <UserContent>
            <Title titleText={"Sản phẩm yêu thích"} />
                    ...
                    <div className="wish-item-info flex justify-between">
                      <div className="wish-item-info-l flex flex-col">
                        ...
                        <ul className="flex flex-col">
                          <li>
                            <span className="text-lg font-bold">Màu :</span>
                            <span className="text-lg text-gray font-medium capitalize">
                              {wishlist.color}
                            </span>
                          </li>
                          <li>
                            <span className="text-lg font-bold">Giá tiền:</span>
                            <span className="text-lg text-gray font-medium capitalize">
                              {wishlist.quantity}
                            </span>
                          </li>

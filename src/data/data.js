...
const navMenuData = [
  ...
  {
    id: "nav-menu-3",
    menuLink: "/product/:phu-kien",
    menuText: "Phụ kiện",
  },
  {
    id: "nav-menu-4",
    menuLink: "/product/:combo-set",
    menuText: "Combos",
  },
...
const footerData = [
  {
    id: "f_need_help",
    title: "Về Shop Hường Mỹ - Thời trang trẻ em",
    links: [
      // { text: "Contact Us", url: "/contact" },
      { text: "Shop Hường Mỹ chuyên bán quần áo trẻ em online với hàng ngàn mẫu mã baby để quý khách lựa chọn cho bé yêu của bạn. Hãy đặt hàng online để được hưởng nhiều ưu đãi hơn tại siêu thị mẹ và bé Babi Chọn mua ngay các mẫu áo quần thời trang trẻ em mới nhất 2024, hàng đẹp bền giá tốt." },
  ...
  },
  {
    ...
    links: [
      {
        text: "Quần Áo Bé Gái", url: "/product/:thoi-trang-be-gai"
      },
      {
        text: "Quần Áo Bé Trai", url: "/product/:thoi-trang-be-trai"
      },
      { text: "Phụ kiện", url: "/product/:phu-kien" },
      { text: "Tất cả sản phẩm", url: "/product/:all" },
    ],
  },
  {
    id: "f_more_info",
    ...
    links: [
      { text: "Hướng dẫn chọn size", url: "/tac" },
      { text: "Giao hàng & phí giao hàng", url: "/shipping" },
      { text: "Chính sách đổi trả hàng", url: "/privacy" },
      { text: "Chính sách bảo mật thông tin", url: "/sitemap" },
    ],
  },
  {
    id: "f_location",
    title: "Liên hệ",
    lists: [
      { text: "Địa chỉ: Ki ốt 40, Chợ mới Thị Trấn, Đô Lương, Nghệ An " },
      { text: "Giờ mở cửa: T2 - T7: 8h30 - 17h. Chủ Nhật: nghỉ" },
      { text: "Số điện thoại: 0988233528" },
      { text: "Gmail : tungdev64@gmail.com" },
    ],
  },
];
...
const socialLinksData = [
  {
    ...
    site_url: "https://www.facebook.com/huong.thaithi.129",
  },
  {
    id: "social_link_2",
    site_name: "instagram",
  ...
  // },
  {
    id: "social_link_4",
    site_name: "gmail",
    site_icon: "bi bi-google",
    // site_url: "tungdev64@gmail.com"
  },
];
